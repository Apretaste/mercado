...
<p>Usted acaba de comprar el art&iacute;culo <b>{$payment->name}</b> por <b>&sect;{$payment->price|string_format: "%.2f"}</b>. Necesitamos que nos env&iacute;e la informaci&oacute;n de quien recibir&aacute; el paquete (generalmente usted) a la direcci&oacute;n compras@apretaste.com.</p>
